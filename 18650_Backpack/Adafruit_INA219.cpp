//https://github.com/jmendeth/power-trinket/blob/master/sketch/_Adafruit_INA219.h

/* Patched to use TinyWireM */
/**************************************************************************/
/*! 
...
{
  TinyWireM.beginTransmission(ina219_i2caddr);
  #if ARDUINO >= 100
   TinyWireM.write(reg);                       // Register
   TinyWireM.write((value >> 8) & 0xFF);       // Upper 8-bits
   TinyWireM.write(value & 0xFF);              // Lower 8-bits
  #else
   TinyWireM.send(reg);                        // Register
   TinyWireM.send(value >> 8);                 // Upper 8-bits
   TinyWireM.send(value & 0xFF);               // Lower 8-bits
  #endif
...
void Adafruit_INA219::wireReadRegister(uint8_t reg, uint16_t *value)
{
 ...
 TinyWireM.requestFrom(ina219_i2caddr, (uint8_t)2);  
  #if ARDUINO >= 100
    // Shift values to create properly formed integer
    *value = ((TinyWireM.read() << 8) |TinyWireM.read());
  #else
    // Shift values to create properly formed integer
